...
# Function to save Humidity to DB Table
def Weight_Data_Handler(jsonData):
	#Parse Data
	json_Dict = json.loads(jsonData)
	SensorID = json_Dict['Sensor_ID']
	Data_and_Time = json_Dict['Date']
	...
	#Push into DB Table
	dbObj = DatabaseManager()
	dbObj.add_del_update_db_record("insert into Weight_Data (SensorID, Date_n_Time, Weight) values (?,?,?)",[SensorID, Data_and_Time, Weight])
	del dbObj
	print("Inserted Weight Data into Database.")
...
def sensor_Data_Handler(Topic, jsonData):
	...
	elif Topic == "Home/BedRoom/1/Weight":
		Weight_Data_Handler(jsonData)
...
if __name__ == "__main__":
	...
	client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION1, "lab3client")
